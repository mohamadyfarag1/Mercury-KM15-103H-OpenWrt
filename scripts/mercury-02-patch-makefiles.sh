...
define Device/mercury_km15-103h
  ...
  DEVICE_PACKAGES := kmod-mt7915e kmod-mt7915-firmware -wpad-basic-mbedtls wpad-mesh-mbedtls kmod-mac80211-mesh usteer luci-app-usteer iw uboot-envtools luci luci-ssl iwinfo wireless-regdb irqbalance zlib libbz2 libopenssl-conf libopenssl3 openssl-util libpython3 python3-base python3-light
